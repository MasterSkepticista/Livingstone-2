...
public abstract class LivingstoneEngineJNI {
    ...
    protected synchronized native int deallocateEngineJNI(int tracker_address,
    ...
    protected synchronized native int propagateJNI()
    throws L2NativeException;
    
    protected synchronized native void minProgressJNI(String cmd)
    throws L2NativeException;
    
    protected synchronized native void fullProgressJNI(String cmd)
    throws L2NativeException;
    ...
    protected synchronized native void assignMultipleJNI(String monitor)
    throws L2NativeException;
    
    protected synchronized native void unassignJNI(String variable)
    throws L2NativeException;
    
    /* return 0=not_found, 1=true, 2=false, 3=unknown */
    protected synchronized native int getPropValueJNI(String propName)
    throws L2NativeException;
    
    protected synchronized native void installCandidateJNI(int candidate_index)
    throws L2NativeException;
    
    protected synchronized native String getFcStyleJNI()
    throws L2NativeException;
    
    protected synchronized native void pruneAndSearchJNI()
    throws L2NativeException;
    
    protected synchronized native void findFreshJNI()
    throws L2NativeException;
    
    protected synchronized native void extendJNI()
    throws L2NativeException;
    
    protected synchronized native String getSearchTerminationJNI()
    throws L2NativeException;
    
    protected synchronized native int getCandidateCountJNI()
    throws L2NativeException;
    
    protected synchronized native int getCandidatePointerJNI(int candidateNum)
    throws L2NativeException;
    
    protected synchronized native void mapOverCandidateAssignmentsJNI(int candidate,
    java.util.Observer o)
    throws L2NativeException;
    
    protected synchronized native int getCandidateClassCountJNI()
    throws L2NativeException;
    
    protected synchronized native int getCandidateClassPointerJNI(int candidateNum)
    throws L2NativeException;
    
    protected synchronized native void mapOverAttributeAssignmentsJNI(java.util.Observer o)
    throws L2NativeException;
    
    protected synchronized native void mapOverAttributeNamesJNI(java.util.Observer o)
    throws L2NativeException;
    
    protected synchronized native void mapOverCommandAttributeNamesJNI(java.util.Observer o)
    throws L2NativeException;
    
    protected synchronized native void mapOverObservableAttributeNamesJNI(java.util.Observer o)
    throws L2NativeException;
    
    protected synchronized native boolean setAttributeModeJNI(String variable,
    String mode)
    throws L2NativeException;
    
    // create checkpoint 'name', throws exception if not created
    protected synchronized native void createCheckpointJNI(String name)
    throws L2NativeException;
    
    // restore checkpoint 'name', throws exception if non-existent
    // returns false if no checkpoints exist, or name is invalid
    protected synchronized native boolean restoreCheckpointJNI(String name)
    throws L2NativeException;
    
    // delete checkpoint 'name', throws exception if non-existent
    protected synchronized native void deleteCheckpointJNI(String name)
    throws L2NativeException;
    
    protected synchronized native int getTimeStepJNI()
    throws L2NativeException;
    
    protected synchronized native void setTransitionVariableAtTimeJNI(String name,
    String value,
    int time)
    throws L2NativeException;
    
    protected synchronized native int[] getHistoryStartStopJNI()
    throws L2NativeException;
    
    protected synchronized native void listenerUsageJNI()
    throws L2NativeException;
    
    protected synchronized native boolean parseCmdJNI(String cmd,
    String args)
    throws L2NativeException;
    ...
    protected synchronized native String variableValueAtTimeJNI(String var_name,
    int time)
    throws L2NativeException;
    
    protected synchronized native boolean variableExogenousAtTimeJNI(String var_name,
    int time)
    throws L2NativeException;
    
    protected synchronized native void printPropClausesJNI(String propname);
    
    // execute L2 cmds without Skunkworks/Stanley updates or interaction
    protected synchronized native void executeWarpCommandsJNI(String commands)
    throws L2NativeException;
