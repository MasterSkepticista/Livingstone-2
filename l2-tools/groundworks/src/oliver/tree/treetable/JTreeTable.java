...
public class JTreeTable extends JTable {
    ...
    protected TreeTableModelAdapter treeTableModelAdapter = null;
    
    public void setTreeTableModel(TreeTableModel treeTableModel) {
        if(treeTableModelAdapter != null) treeTableModelAdapter.cleanup();
    ...
    TableCellRenderer {
        ...
        public TreeTableCellRenderer(TreeModel model) {
            super(model);
            setCellRenderer(new oliver.tree.InstanceTreeCellRenderer());
        }
