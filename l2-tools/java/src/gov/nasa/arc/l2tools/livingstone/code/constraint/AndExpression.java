 ...
 * Creation date: (3/6/2000 11:39:29 AM)
 * @author: Andrew Bachmann
 */
public class AndExpression extends Expression {
	public final static String tagName = "ex:and";
  // compilation caches
	...
	try {
		...
		while (expressions.hasMoreElements()) {
			...
			if (expression instanceof Expression) {
				...
				setExpression(getExpression().destructiveConjunction(((Expression)expression).getExpression()));
			} else {
