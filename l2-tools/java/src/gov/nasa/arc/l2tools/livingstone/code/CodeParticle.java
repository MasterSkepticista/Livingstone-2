 ...
 */
public abstract class CodeParticle extends gov.nasa.arc.l2tools.livingstone.code.Particle 
  implements Cachable, Compilable {
  public final static String tagName = "codeparticle";
	...
	private java.lang.Integer column = null;
 ...
 */
public CodeParticle(String name) {
	super(name);
}
/**
 *
...
/**
 * Creation date: (6/28/2000 12:31:45 PM)
 * @author: Andrew Bachmann
 * 
 ...
 */
protected void setColumn(java.lang.Integer newColumn) {
	column = newColumn;
}
/**
 *
