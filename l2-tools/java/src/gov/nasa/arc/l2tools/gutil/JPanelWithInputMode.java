...
/*
* Author : Mark Shirley
* Description : JPanelWithInputMode.java
*
...
/** Extension of JPanel with Shirley's input mode handling.  */
public class JPanelWithInputMode extends JPanel implements InputSurface {
