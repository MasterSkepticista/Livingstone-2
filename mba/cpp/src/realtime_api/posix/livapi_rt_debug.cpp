...
void *debug_observation_timeout(void *param)
{
	...
	(&rti->thequeue)->decrement_timeouts();
	return 0;
}
...
L2_rtapi_debug::L2_rtapi_debug(Tracker *syst, ReporterInterface &livrep_in) : L2_rtapi(syst, livrep_in)
{
